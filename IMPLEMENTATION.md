...
| **Treasury is nearly dry** | ~$4 left; Foreman (the funding source) has ~$2.80. Every demo run spends real testnet USDC. Needs a funding answer before seeding production or rehearsing. |
